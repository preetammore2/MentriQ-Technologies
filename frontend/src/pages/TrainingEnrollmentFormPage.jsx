...
const TrainingEnrollmentFormPage = () => {
    ...
    const { checkEnrollments } = useAuth()
                ...
                <div className="md:w-2/5 bg-white/5 backdrop-blur-md text-white p-10 flex flex-col justify-between relative overflow-hidden border-r border-white/5">
                    ...
                    <div className="mt-8 relative z-10">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="font-bold text-sm text-indigo-100 uppercase tracking-wider">Secure Enrollment</span>
                        </div>
                        <p className="text-xs text-gray-400 leading-relaxed">
                            Your info is protected by 256-bit encryption. Enroll with confidence.
                        </p>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-4">
                            <button className="w-full relative group overflow-hidden bg-indigo-600 text-white font-black py-5 rounded-[1.5rem] hover:bg-indigo-700 transition-all duration-500 flex items-center justify-center gap-3 active:scale-95 shadow-2xl shadow-indigo-600/20">
                                ...
                                <span className="uppercase tracking-[0.2em] text-sm">Submit Registration</span>
                            </button>
                            <p className="text-center text-[10px] text-gray-500 mt-6 uppercase tracking-widest opacity-50">By registering, you agree to our training terms</p>
                        </div>
                    </form>
                </div>
            </motion.div>
