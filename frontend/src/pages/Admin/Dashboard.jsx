        ...
        const fetchStats = async () => {
            try {
                ...
                try {
                    ...
                    setStats({
                        totalUsers: users.data?.length || mockStats.totalUsers,
                        totalCourses: courses.data?.length || mockStats.totalCourses,
                        totalEnrollments: enrollments.data?.length || mockStats.totalEnrollments,
