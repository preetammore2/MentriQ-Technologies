    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-[#1e293b] p-8 rounded-3xl border border-white/5 shadow-xl">
                <div>
                    <h2 className="text-3xl font-bold text-white tracking-tight">Our Journey</h2>
                    <p className="text-gray-400 text-sm mt-1">Manage historical milestones and company trajectory.</p>
                </div>
                <button
                    onClick={() => {
                        setEditingMilestone(null);
