                ...
                <div className="flex-1 relative min-h-[400px] lg:min-h-auto">
                    ...
                    <div className="absolute inset-0 pointer-events-none z-20">
                        ...
                        <motion.a
                            ...
                            className="absolute top-[20%] left-[20%] w-12 h-12 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#0077b5] hover:border-[#0077b5]/30 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[10%] left-[35%] w-10 h-10 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-black hover:border-black/20 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[5%] right-[40%] w-14 h-14 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-xl pointer-events-auto hover:text-[#e1306c] hover:border-[#e1306c]/30 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[12%] right-[20%] w-10 h-10 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#25D366] hover:border-[#25D366]/30 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[25%] right-[10%] w-12 h-12 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#EA4335] hover:border-[#EA4335]/30 transition-all duration-300"
                        >
