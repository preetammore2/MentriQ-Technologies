                ...
                <div className="flex-1 relative min-h-[400px] lg:min-h-auto">
                    ...
                    <div className="absolute inset-0 pointer-events-none z-20">
                        ...
                        <motion.a
                            ...
                            className="absolute top-[20%] left-[20%] w-12 h-12 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#0077b5] hover:bg-[#0077b5]/10 hover:border-[#0077b5]/20 hover:scale-110 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[10%] left-[35%] w-10 h-10 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-black hover:bg-black/5 hover:border-black/10 hover:scale-110 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[5%] right-[40%] w-14 h-14 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#e1306c] hover:bg-[#e1306c]/10 hover:border-[#e1306c]/20 hover:scale-110 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            ...
                            className="absolute top-[12%] right-[20%] w-10 h-10 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#25D366] hover:bg-[#25D366]/10 hover:border-[#25D366]/20 hover:scale-110 transition-all duration-300"
                        >
                        ...
                        <motion.a
                            href="mailto:info@mentriq.com"
                            target="_blank"
                            rel="noopener noreferrer"
                            initial={{ opacity: 0, scale: 0 }}
                            animate={{ opacity: 1, scale: 1, y: [0, -10, 0] }}
                            transition={{ duration: 3.2, repeat: Infinity, ease: "easeInOut", delay: 1.4 }}
                            className="absolute top-[25%] right-[10%] w-12 h-12 rounded-full bg-white/5 border border-white/10 backdrop-blur-md flex items-center justify-center text-slate-400 shadow-lg pointer-events-auto hover:text-[#EA4335] hover:bg-[#EA4335]/10 hover:border-[#EA4335]/20 hover:scale-110 transition-all duration-300"
                        >
