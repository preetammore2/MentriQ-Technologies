        ...
        <div className="w-full min-h-[85vh] relative overflow-hidden bg-white pt-20">
            ...
            <div className="flex flex-col lg:flex-row h-full min-h-[85vh] relative z-10">
                ...
                <div className="flex-1 p-8 lg:p-16 flex flex-col justify-center">
                    ...
                    {/* Social Media Icons (Floating Glass Theme) */}
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    >
                        {[
                            ...
                            },
                            {
                                ...
                                color: 'hover:text-black hover:bg-black/5 hover:border-black/10'
                            },
                            {
                                name: 'Instagram',
                            ...
                            },
                            {
                                ...
                                url: 'mailto:info@mentriq.com',
                                color: 'hover:text-[#EA4335] hover:bg-[#EA4335]/10 hover:border-[#EA4335]/20'
                            }
                        ].map((social, index) => (
                            <motion.a
                                key={social.name}
                                ...
                                className={`w-12 h-12 rounded-full bg-white/5 border border-slate-200 backdrop-blur-md flex items-center justify-center text-slate-400 transition-all duration-300 shadow-md hover:shadow-xl ${social.color}`}
                            >
                                {social.icon}
                            </motion.a>
                        ))}
